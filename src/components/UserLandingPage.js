...
export class UserLandingPage extends Component {
    ...
    callAPI() {
        ...
        fetch('http://localhost:9000/' + _id)
            ...
            .then(res => this.setState({
                ...
                score: res.score,
                challengesCreated: res.challengesCreated === "" ? []: res.challengesCreated,
    ...
    deleteAccount = (event) => {
        ...
        fetch('http://localhost:9000/deleteUser', {
            ...
            body: JSON.stringify({"user_id": jwt_decode(localStorage.getItem("token")).user._id, "password": password})
    ...
    render() {
        ...
        return (
            <div id="userInformation">
                ...
                <button className="delAccount" onClick={this.deleteAccount}>Delete Account</button>
            </div>
        );
    }
}
